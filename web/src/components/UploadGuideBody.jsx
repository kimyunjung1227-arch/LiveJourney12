...
/**
 * 업로드 가이드 본문 — UploadGuideScreen / UploadScreen 모달에서 공통 사용
 */
export default function UploadGuideBody() {
  return (
    <div className="px-1">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="shrink-0 text-primary text-xs font-bold">Live</div>
      </div>
