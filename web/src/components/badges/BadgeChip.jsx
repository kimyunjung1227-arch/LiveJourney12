...
export function getChipTone(tier, earned = true) {
  if (!earned) {
    return {
      ...
      text: '#9AA3AB',
      shadow: 'none',
      iconPalette: { key: '#C2C8CE', sub: '#DDE1E5', accent: '#CDD2D7' },
    };
  }
  switch (tier) {
    case 'high': // 마스터 — 솔리드 하늘색 + 흰 텍스트/아이콘
      return {
        ...
        iconPalette: { key: '#FFFFFF', sub: 'rgba(255,255,255,0.55)', accent: '#FFE08A' },
      };
    case 'mid': // 톡파원/카테고리 — 옅은 하늘 + 하늘색
      return {
        ...
        text: '#1577B5',
        shadow: 'none',
        iconPalette: { key: '#2BA0DC', sub: '#A9D9F2', accent: '#FFC24D' },
      };
    ...
    default:
      return {
        ...
        text: '#4E83AC',
        shadow: 'none',
        iconPalette: { key: '#5FB6E4', sub: '#BCE0F4', accent: '#FFC24D' },
      };
  }
}
