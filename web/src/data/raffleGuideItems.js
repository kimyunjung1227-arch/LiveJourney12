...
export const RAFFLE_GUIDE_ITEMS = [
  ...
  },
  {
    ...
    body:
      '실시간 활동과 전문성이 쌓일수록 래플 당첨 확률이 기하급수적으로 높아집니다.\n\n[실시간 도움 응모권]\n• 방법: 다른 여행자의 실시간 도움 요청(Q&A)에 답변하고 채택될 때 지급됩니다.\n• 수량: 답변 채택 1건당 1표\n• 특징: 래플에 응모하는 순간 즉시 소모됩니다. (실시간 활동을 장려하기 위한 규칙입니다.)\n\n[뱃지 추첨권 — 지역 뱃지]\n시즌/테마 뱃지가 아니라, 내가 실제로 다닌 지역 기반의 \"지역 뱃지\"가 추첨권으로 반영됩니다.\n\n• 기준: 지역 뱃지(예: 서울/부산/제주 등)\n• 장수: 지역 뱃지 등급(tier)에 따라 가중치가 달라집니다.\n  - tier1: 1장\n  - tier2: 5장\n  - tier3: 10장\n\n예시: 실시간 도움 응모권 3장을 모은 상태에서, 서울 지역 뱃지(tier1=1장), 부산 지역 뱃지(tier3=10장), 제주 지역 뱃지(tier2=5장)를 획득한 뒤 래플에 응모하면 총 19장이 반영되어 당첨 확률이 매우 높아집니다.\n\n[보유·재사용]\n뱃지로 획득한 추첨권은 응모했다고 해서 사라지지 않으며, 이후 다른 래플에서도 동일한 조건으로 계속 응모에 활용할 수 있습니다. (단, 실시간 도움 응모권만 응모 시 소모됩니다.)',
  },
  {
    id: 'steps',
