  ...
  const loadRegionData = useCallback(async () => {
    ...
    const formattedPosts = regionPosts
      .map(post => ({
        ...
        videos: (post.videos || []).map((u) => getDisplayImageUrl(u, { allowBlob: true })),
        image: getDisplayImageUrl(post.images?.[0] || post.videos?.[0] || post.image || post.thumbnail, { allowBlob: true }),
          ...
          <main>
            ...
            <div>
              ...
              <div className="flex items-center justify-between px-4 pb-1 pt-4">
                <h2 className="text-[13px] font-medium leading-tight tracking-[-0.01em] text-text-headings dark:text-gray-100">
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        className={`group inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-medium whitespace-nowrap flex-shrink-0 border transition-colors duration-150 ${
                          isActive
